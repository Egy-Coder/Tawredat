...
namespace BL
{
    public partial class TawredatDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        public virtual DbSet<TbCityDeliveryFees> TbCityDeliveryFeess { get; set; }

        public virtual DbSet<TbSupplierCategory> TbSupplierCategories { get; set; }

        public virtual DbSet<TbSupplierSubscription> TbSupplierSubscriptions { get; set; }

        public virtual DbSet<TbPurchaseSubscribtion> TbPurchaseSubscribtions { get; set; }

        public DbSet<TbRealTimeNotifcation> TbRealTimeNotifcations { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TbCityDeliveryFees>(entity =>
            {
                entity.HasKey(e => e.CityDeliveryFeesId);

                entity.ToTable("TbCityDeliveryFees");

                entity.Property(e => e.CityDeliveryFeesId).HasDefaultValueSql("(newid())");

                entity.Property(e => e.CityName).HasMaxLength(200);

                entity.Property(e => e.DeliveryFees).HasMaxLength(200);
            ...
            modelBuilder.Entity<TbSupplierCategory>(entity =>
            {
                entity.HasKey(e => e.SupplierCategoryId);

                entity.ToTable("TbSupplierCategory");

                entity.Property(e => e.SupplierCategoryId).HasDefaultValueSql("(newid())");
                ...
                entity.Property(e => e.SupplierCategoryDescription).HasMaxLength(200);
            ...
            modelBuilder.Entity<TbSupplierSubscription>(entity =>
            {
                entity.HasKey(e => e.SupplierSubscriptionId);

                entity.ToTable("TbSupplierSubscription");

                entity.Property(e => e.SupplierSubscriptionId).HasDefaultValueSql("(newid())");
                ...
                entity.Property(e => e.SupplierId).HasColumnType("uniqueidentifier");

                entity.Property(e => e.Notes).HasMaxLength(200);



                entity.Property(e => e.SubscriptionPackage).HasMaxLength(200);
            ...
            modelBuilder.Entity<TbPurchaseSubscribtion>(entity =>
            {
                entity.HasKey(e => e.PurchaserSubscriptionId);

                entity.ToTable("TbPurchaseSubscribtion");

                entity.Property(e => e.PurchaserSubscriptionId).HasDefaultValueSql("(newid())");
                ...
                entity.Property(e => e.PurchaserId).HasColumnType("uniqueidentifier");

                entity.Property(e => e.PurchaserName).HasMaxLength(200);
            ...
            modelBuilder.Entity<TbSupplierProduct>(entity =>
            {
                ...
                entity.Property(e => e.FreeShipping).HasMaxLength(200);
