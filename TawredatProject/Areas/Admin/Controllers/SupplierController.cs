...
namespace TawredatProject.Areas.Admin.Controllers
{
    ...
    public class SupplierController : Controller
    {
        ...
        public SupplierController(SupplierCategoryService SupplierCategoryService,CityService CityService,SupplierService SupplierService, TawredatDbContext context)
        {
            supplierCategoryService = SupplierCategoryService;
            supplierService = SupplierService;
            ctx = context;
        ...
        public IActionResult Form(Guid? id)
        {
            ...
            ViewBag.SuppliersCategories = supplierCategoryService.getAll();
            return View(oldItem);
        }
    }
}
